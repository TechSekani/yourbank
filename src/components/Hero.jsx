...
const Hero = () => {
  return (
    <section className=" flex md:flex-row flex-col gap-16 md:gap-[90px] md:h-[87vh]">
      ...
      <div className="relative md:mt-7 md:w-2/5">
        <img src={arrows} alt="" className="absolute top-3 md:top-8 -right-3 md:-right-[68px] w-[200px] md:w-[300px] -z-10" />
