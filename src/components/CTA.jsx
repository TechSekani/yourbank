...
const CTA = () => {
  return (
    <article className="overflow-hidden mx-2 md:mx-0 mb-20 relative bg-ctaBg flex flex-col md:flex-row text-center md:text-start gap-6 md:gap-0 justify-between items-center py-8 md:p-12 rounded-xl border border-[#262626]">
